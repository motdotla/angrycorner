...
class Api(object):
    ...
    def get_trends_closest(self, latitude, longitude):
        # https://api.twitter.com/1.1/trends/closest.json?lat=37.781157&long=-122.400612831116
        auth_token = self._get_auth()

        url = "https://api.twitter.com/1.1/trends/closest.json?lat=%s&long=%s" % (latitude, longitude) 
    ...
    def get_trends_place(self, woeid):
        ...
        url = "https://api.twitter.com/1.1/trends/place.json?id=%s" % woeid 
